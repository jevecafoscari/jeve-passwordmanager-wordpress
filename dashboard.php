                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="m-r-10"><a class="btn btn-circle d-flex btn-info text-white">&nbsp;<?php echo $row['id']; ?></a>
                                                                        </div>
                                                                        <?php echo $row['nome']; ?>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td><label class="badge bg-danger"><?php echo $row['accessi']; ?></label> </td>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <a class="m-r-10 mdi mdi-delete" href="elimina_utente.php?id=<?php echo $row['id']; ?>" </a>
                                                                    </td>
                                                                <?php } ?>
